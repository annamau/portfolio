...
class Renderer {
  ...
  render(now = 0) {
    ...
    gl.uniform2f((program as Record<string, unknown>).resolution as WebGLUniformLocation, canvas.width, canvas.height);
    gl.uniform1f((program as Record<string, unknown>).time as WebGLUniformLocation, now * 1e-3);
    gl.uniform3fv((program as Record<string, unknown>).u_color as WebGLUniformLocation, this.color);
